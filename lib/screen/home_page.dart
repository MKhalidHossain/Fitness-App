              ...
              child: Stack(
                children: [
                  ClipRRect(
                    ...
                    child: Image.network("${myList[index].image}",fit: BoxFit.cover,width: double.infinity,),
                  ),
                  ...
                  Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text("${myList[index].title}",style: TextStyle(color: Colors.white,fontSize: 20),),
                    height: 60,
